...
//=============[기능]===============
#define Nitro_Money 350000 // 니트로 가격
...
#define CAR_CASH 2500000 // 차량가격 (250만) // 직업 때문에 0원
#define CAR_SHOW 0 //차량소환할때 돈
#define CAR_CELL 1900000 // 차량 팔때 가격 (모든 차량 통합)
...
//	AddStaticVehicle(411,2510.0017,-1687.3872,13.2750,44.3877,116,1); // 창고 옆 파란 인페 차량
	AddStaticVehicle(411,2516.1982,-1686.0061,13.1141,53.9250,116,1); // 창고 옆 파란 인페 차량 위치
...
// 2010년 8월 21일 토요일 PM 5:21 어드민존 /admincj2 차량 배치
AddStaticVehicle(520,1285.4541,-3565.3647,32.0353,233.8062,0,0); //
AddStaticVehicle(520,1285.8669,-3575.8582,31.3821,89.8558,0,0); //
AddStaticVehicle(565,1241.1339,-3562.2773,30.2806,270.1561,42,42); //
AddStaticVehicle(470,1241.4922,-3565.7363,30.6498,270.6683,43,0); //
AddStaticVehicle(490,1242.1934,-3569.2197,30.7885,273.3159,0,0); //
AddStaticVehicle(506,1242.1387,-3572.9993,30.3628,274.8094,7,7); //
AddStaticVehicle(413,1241.6143,-3577.5181,30.7450,272.7954,4,1); //
AddStaticVehicle(504,1242.1022,-3581.0442,30.4508,273.7849,57,38); //
AddStaticVehicle(469,1248.5305,-3593.8162,30.6699,265.0407,1,3); //
AddStaticVehicle(411,1241.1306,-3587.6787,30.2664,270.9678,6,25); //
AddStaticVehicle(480,1241.3291,-3584.0981,30.4182,272.9315,2,2); //
AddStaticVehicle(527,1242.4310,-3612.9536,30.3711,270.1562,76,1); //
AddStaticVehicle(476,1247.9154,-3673.1882,31.2192,275.7942,7,6); //

// 고맴들이랑 배치한 비행기 오토바이 차량 등
AddStaticVehicle(411,822.2773,-1844.8381,12.3174,184.3982,112,1); //
AddStaticVehicle(411,822.1081,-1838.0100,12.1693,185.1187,12,1); //
AddStaticVehicle(411,821.8310,-1831.9087,12.0641,183.0986,64,1); //
AddStaticVehicle(411,821.4444,-1826.0022,11.9906,182.7637,80,1); //
AddStaticVehicle(411,1853.8608,-1606.7903,13.0517,90.2242,112,1); //
AddStaticVehicle(411,1859.3588,-1606.6801,13.0544,87.8687,116,1); //
AddStaticVehicle(411,1865.3195,-1606.7167,13.0617,90.0206,123,1); //
AddStaticVehicle(411,1870.4749,-1606.6091,13.0608,91.2099,75,1); //
AddStaticVehicle(411,1877.7765,-1606.6306,13.0739,90.3766,80,1); //
AddStaticVehicle(411,1522.1655,-1387.4591,334.3041,206.9903,116,1); //
AddStaticVehicle(411,1525.4724,-1386.0881,335.1599,205.5018,123,1); //
AddStaticVehicle(411,1518.3823,-1388.8458,332.4122,202.0599,75,1); //
AddStaticVehicle(411,1528.5464,-1385.0110,333.4697,202.7916,12,1); //
AddStaticVehicle(411,1531.8577,-1383.9197,334.4353,199.6853,112,1); //
AddStaticVehicle(411,1534.8608,-1382.5930,334.3693,203.9185,64,1); //
AddStaticVehicle(411,1541.8289,-1380.1246,333.7020,200.1768,123,1); //
AddStaticVehicle(411,1538.0531,-1381.3185,332.4283,201.7162,75,1); //
AddStaticVehicle(522,1543.7600,-1415.8600,334.4066,22.7857,51,118); //
AddStaticVehicle(522,1545.2904,-1414.9829,332.6579,18.7617,51,118); //
AddStaticVehicle(522,1546.7581,-1414.3889,332.0627,12.3735,39,106); //
AddStaticVehicle(522,1541.8607,-1416.6569,331.7448,19.2883,7,79); //
AddStaticVehicle(522,1540.5310,-1417.1201,332.6931,17.9883,3,3); //
AddStaticVehicle(522,1539.0479,-1417.6613,332.6631,16.3002,8,82); //
AddStaticVehicle(522,1537.8068,-1417.9075,331.7234,7.4728,3,8); //
AddStaticVehicle(522,1549.0569,-1450.5861,336.8719,282.1871,3,3); //
AddStaticVehicle(522,1529.5649,-1417.1663,331.4438,287.7385,3,3); //
AddStaticVehicle(522,1529.9072,-1418.1025,331.4832,295.0098,39,106); //
AddStaticVehicle(522,1528.4944,-1414.4122,331.5430,285.2146,3,8); //
AddStaticVehicle(411,1528.4047,-1411.5259,331.4138,291.7386,80,1); //
AddStaticVehicle(519,1534.4548,-1402.4296,340.8486,173.4149,1,1); //
AddStaticVehicle(519,1171.1295,-3706.2078,37.5443,180.6528,1,1); //
AddStaticVehicle(519,1187.6855,-3679.4453,35.7183,99.0226,1,1); //
AddStaticVehicle(519,1900.5044,-2470.2878,14.4620,88.6487,1,1); //

// 2010년 8월 22일 일요일 PM 9:52 이후 차량 배치
AddStaticVehicle(579,2152.1367,1408.8655,10.7429,3.1881,62,62); //
AddStaticVehicle(579,2148.3967,1408.8992,10.7493,359.2357,7,7); //
AddStaticVehicle(579,2145.4546,1408.9550,10.7509,1.7902,11,11); //
AddStaticVehicle(475,2142.1697,1408.8693,10.6233,359.1461,9,39); //
AddStaticVehicle(402,2132.5388,1408.6685,10.6519,359.8972,13,13); //
AddStaticVehicle(496,2104.0869,1398.1151,10.5361,4.6640,66,72); //
AddStaticVehicle(602,2100.6140,1398.3395,10.6314,184.8276,69,1); //
AddStaticVehicle(588,2137.3923,1410.1543,10.7248,356.2410,1,1); //
AddStaticVehicle(588,2470.3169,-1653.2177,13.3020,98.0055,1,1); //
AddStaticVehicle(434,2113.5784,1409.0240,10.7746,183.1875,12,12); //
AddStaticVehicle(432,1288.6975,-3602.8535,30.6683,92.8289,43,0); //
AddStaticVehicle(467,2269.0659,2460.4077,10.5603,357.8109,58,8); //
AddStaticVehicle(599,2225.2227,2454.2346,11.0467,305.4899,0,1); //
AddStaticVehicle(598,2230.1038,2453.7209,10.6052,64.6284,0,1); //
AddStaticVehicle(597,2224.9919,2451.3054,10.6139,329.9044,0,1); //
AddStaticVehicle(545,2199.0605,2475.0090,10.6312,0.1943,47,1); //
AddStaticVehicle(431,2296.9490,-1653.3739,14.8186,88.5249,75,59); //
AddStaticVehicle(562,1994.1931,948.5466,10.4783,264.9587,116,1); //
AddStaticVehicle(580,1993.1643,952.3488,10.6165,91.2332,81,81); //
AddStaticVehicle(565,1993.7426,956.2342,10.4480,270.8741,15,15); //
AddStaticVehicle(574,2169.4609,2009.8405,10.5455,265.3069,26,26); //
AddStaticVehicle(562,2171.0481,1989.5448,10.4769,269.6200,116,1); //
AddStaticVehicle(411,2185.3325,2000.3821,10.4091,267.5588,75,1); //
AddStaticVehicle(442,2186.2700,2004.1019,10.6525,270.0023,11,105); //
AddStaticVehicle(554,2171.2603,2000.6294,10.8988,83.8661,15,32); //
AddStaticVehicle(411,2186.8123,1995.7881,10.4092,270.6666,86,1); //

// 추가배치
AddStaticVehicle(411,2042.3958,2469.0051,10.4115,180.8885,80,1); //
AddStaticVehicle(411,2153.5342,2509.6968,10.4093,89.3115,86,1); //
AddStaticVehicle(562,2078.2183,2479.6472,10.4784,1.7649,17,1); //
AddStaticVehicle(522,2143.6602,2468.4695,10.3834,8.3136,3,3); //
AddStaticVehicle(522,2139.1189,2468.4324,10.3884,7.8354,3,8); //
AddStaticVehicle(578,2144.4810,2517.9075,11.4417,185.6439,1,1); //
AddStaticVehicle(522,2135.1294,2468.6729,10.3914,12.9890,6,25); //
AddStaticVehicle(416,2133.8777,2489.6570,10.9708,182.4767,1,3); //
AddStaticVehicle(416,2121.8320,2496.8423,10.9700,93.3924,1,3); //
AddStaticVehicle(416,2139.6357,2516.5403,10.9684,189.5755,1,3); //
AddStaticVehicle(582,2152.1846,2505.6384,10.8785,91.4502,41,20); //
AddStaticVehicle(573,2121.0195,2513.9705,11.4706,263.7473,115,43); //
AddStaticVehicle(457,2155.4912,2466.4412,10.4470,92.2525,2,1); //
AddStaticVehicle(522,2131.2073,2468.9231,10.3911,353.8211,7,79); //
AddStaticVehicle(522,2122.6628,2469.6975,10.3809,353.0190,8,82); //
AddStaticVehicle(522,2127.0427,2469.3347,10.3881,353.0458,39,106); //
AddStaticVehicle(522,2118.8027,2468.9854,10.3923,355.5786,36,105); //
AddStaticVehicle(583,2155.0781,2468.8118,10.3605,94.6413,1,1); //
AddStaticVehicle(471,2152.9392,2501.6130,10.3017,88.9453,103,111); //
AddStaticVehicle(408,2150.7627,2520.1086,11.3392,191.5889,26,26); //
AddStaticVehicle(533,2107.0984,2479.5605,10.5294,1.6486,74,1); //
AddStaticVehicle(424,2103.0659,2479.4961,10.6086,1.8140,3,6); //
AddStaticVehicle(421,2098.9412,2479.8225,10.7026,3.1311,25,1); //
AddStaticVehicle(423,2043.6201,2479.9358,10.8504,0.8577,1,17); //

AddStaticVehicle(495,1877.6011,-2397.5171,13.9058,0.9273,88,99); //
AddStaticVehicle(603,2335.3040,-1772.3488,13.3869,178.2010,45,45); //
AddStaticVehicle(511,-1318.7600,-151.3021,15.5203,315.6364,12,60); //
AddStaticVehicle(511,1925.1431,-2433.9492,14.9159,87.2061,12,60); //
AddStaticVehicle(600,2331.0715,-1778.6693,13.2701,178.7549,81,8); //
AddStaticVehicle(522,-1312.1924,-158.9927,13.7187,314.9770,3,3); //
AddStaticVehicle(522,-1313.3811,-158.1639,13.7040,305.6064,39,106); //
AddStaticVehicle(522,-1314.4250,-156.9468,13.7100,306.4272,3,8); //
AddStaticVehicle(522,-1315.7256,-155.1104,13.7167,298.4724,51,118); //
AddStaticVehicle(522,-1314.9298,-155.9859,13.7171,314.1790,6,25); //

// 추가 2
AddStaticVehicle(519,1880.7864,-2381.8066,14.4719,80.8542,1,1); //
AddStaticVehicle(605,2448.3425,11.4757,26.2953,85.5929,32,8); //
AddStaticVehicle(480,2458.2048,0.0140,26.1820,184.2590,6,6); //
AddStaticVehicle(603,1898.8374,-2428.9675,13.3772,86.3234,69,1); //
AddStaticVehicle(602,1897.4819,-2432.9492,13.3443,91.0629,18,1); //
AddStaticVehicle(506,1897.9989,-2437.0271,13.2435,85.1922,52,52); //
AddStaticVehicle(502,1912.1051,-2441.4873,13.4305,78.0341,53,75); //
AddStaticVehicle(506,1905.0273,-2440.8743,13.2438,81.6434,76,76); //
AddStaticVehicle(495,1877.6011,-2397.5171,13.9058,0.9273,88,99); //
AddStaticVehicle(603,2335.3040,-1772.3488,13.3869,178.2010,45,45); //
AddStaticVehicle(511,-1318.7600,-151.3021,15.5203,315.6364,12,60); //
AddStaticVehicle(522,-1306.2496,-160.0969,13.7173,318.7145,39,106); //
AddStaticVehicle(522,-1314.1387,-153.1384,13.7158,302.9263,3,3); //
AddStaticVehicle(522,-1313.0724,-154.0705,13.7000,293.5078,36,105); //
AddStaticVehicle(522,-1311.8773,-155.3022,13.7220,307.3024,51,118); //
AddStaticVehicle(522,-1310.7415,-155.7745,13.7385,307.2156,3,8); //
AddStaticVehicle(522,-1309.8154,-157.3413,13.7034,311.9637,8,82); //
AddStaticVehicle(522,-1308.8243,-158.3350,13.7166,312.1822,6,25); //
AddStaticVehicle(522,-1307.3368,-159.5922,13.7172,315.2705,7,79); //
AddStaticVehicle(411,-1311.5746,-170.0804,13.7374,311.8420,123,1); //
AddStaticVehicle(411,-1300.6490,-171.2657,13.7442,311.0322,80,1); //
AddStaticVehicle(411,-1297.9371,-174.0595,13.7493,315.5094,75,1); //
AddStaticVehicle(411,-1295.7577,-176.2632,13.7361,316.8480,12,1); //
AddStaticVehicle(411,-1303.0800,-179.0740,13.7420,315.1000,112,1); //
AddStaticVehicle(411,-1305.7531,-176.1346,13.7403,316.6649,64,1); //
AddStaticVehicle(411,-1300.4875,-181.6973,13.7569,316.6656,106,1); //
AddStaticVehicle(411,-1308.5437,-173.1809,13.7551,312.3580,116,1); //
AddStaticVehicle(560,419.7258,2531.8699,16.3016,184.5244,17,1); //

// 추가 3

AddStaticVehicle(411,390.5260,2531.1155,16.1299,89.7640,12,1); //
AddStaticVehicle(560,382.1711,2584.0854,16.0504,357.2426,9,39); //
AddStaticVehicle(560,374.1207,2584.2141,16.0733,305.0945,52,39); //
AddStaticVehicle(560,394.8676,2589.8804,16.0778,273.6953,56,29); //
AddStaticVehicle(511,325.9281,2531.6143,18.1736,178.8298,12,60); //
AddStaticVehicle(522,386.8642,2540.5955,16.0739,84.5669,3,3); //
AddStaticVehicle(522,386.7678,2538.9834,16.0902,97.5487,39,106); //
AddStaticVehicle(522,386.8321,2537.3142,16.1049,86.2206,6,25); //
AddStaticVehicle(522,386.5473,2535.6257,16.0994,91.0561,8,82); //
AddStaticVehicle(522,386.5430,2534.0757,16.1015,88.5734,36,105); //
AddStaticVehicle(506,388.6649,2544.0862,16.2450,85.0527,76,76); //

// 추가 4
AddStaticVehicle(522,1559.2168,1663.0258,10.3773,86.0141,39,106); //
AddStaticVehicle(522,1559.3279,1661.5934,10.3597,92.7306,6,25); //
AddStaticVehicle(522,1559.4159,1659.6578,10.3809,79.8927,8,82); //
AddStaticVehicle(522,1559.0238,1657.5250,10.3827,88.8776,51,118); //
AddStaticVehicle(522,1559.1517,1655.8630,10.3731,84.4975,3,8); //
AddStaticVehicle(522,1559.3525,1654.4949,10.3890,87.3127,3,3); //
AddStaticVehicle(411,1564.1196,1661.5457,10.4259,86.4131,64,1); //
AddStaticVehicle(411,1563.6780,1657.6049,10.4255,86.2939,123,1); //
AddStaticVehicle(411,1563.0796,1654.2559,10.4088,87.3059,116,1); //
AddStaticVehicle(506,1556.9453,1650.5002,10.5248,80.8040,52,52); //
AddStaticVehicle(411,1563.5352,1647.5408,10.4092,92.3653,75,1); //
AddStaticVehicle(411,1563.5708,1644.4662,10.4192,89.2425,112,1); //
AddStaticVehicle(411,1569.9829,1657.2062,10.4387,89.2850,106,1); //
AddStaticVehicle(411,1569.0898,1654.0975,10.4091,87.1495,12,1); //
AddStaticVehicle(411,1569.5013,1650.5957,10.4091,90.2704,116,1); //
AddStaticVehicle(411,1569.2448,1647.2316,10.4093,88.9727,64,1); //
AddStaticVehicle(411,1569.5375,1644.1292,10.4186,87.4664,112,1); //
AddPlayerClass(0,297.8980,-1818.0790,4.2395,112.4904,0,0,0,0,0,0); //
...
return SendClientMessage(playerid, 0xFF4040FF, " + 그 차는 니트로를 달 수 없는 차량입니다");
                ...
                return SendClientMessage(playerid, 0x40FF40FF, " + 니트로를 달았습니다 (가격 35만원) 니트로가 꺼진다음에 다시 마우스왼쪽 버튼을 누르면 쓸수있습니다");
  }
...
// carbuys 명령어
	if (strcmp(stringslice(cmdtext,0), "/carbuys", true)==0)
	{
	GetPlayerName(playerid, playername, MAX_PLAYER_NAME);
		new countcar;
		if(!IsPlayerInAnyVehicle(playerid))
...
*/
		...
		if(GetPlayerMoney(playerid)<CAR_CASHS)
		{
			format(string,sizeof(string)," + $%d가 부족합니다.",CAR_CASHS-GetPlayerMoney(playerid));
			SendClientMessage(playerid,COLOR_ORANGERED,string);
			format(string,sizeof(string)," + 차량1대값은 $%d입니다.",CAR_CASHS);
			SendClientMessage(playerid,COLOR_ORANGERED,string);
			return 1;
		}
		for(new i=0; i<MAX_VEHICLES; i++)
		...
		if(countcar>=MAX_GET_CARS)
		{
			SendClientMessage(playerid,COLOR_ORANGERED," + 소유차량갯수가 허용갯수를 초과합니다!");
			SendClientMessage(playerid,COLOR_ORANGERED," + 아무차나 팔후 다시 시도하십시요.");
			format(string,sizeof(string)," + 이 장소에서 1인당 최대 허용 소유 차량은 %d대입니다.",MAX_GET_CARS);
			SendClientMessage(playerid,COLOR_ORANGERED,string);
			return 1;
		}
		if(!strlen(carbuy_table[GetPlayerVehicleID(playerid)]))
		...
		//	dini_Set("cardata2.cfg",keydata,carbuy_table[GetPlayerVehicleID(playerid)]);
			// 차를 구매시 cardata 를 하나 더 만든다
			GivePlayerMoney(playerid, -CAR_CASHS); // 차량 가격을 뺀다
			format(string,sizeof(string)," + 차를 샀습니다!");
			printf(" + 알림 서비스 %s (id : %d) 님이 차량을 구매 하였습니다 ",playername,playerid);
		//	GetPlayerName(playerid, playername, MAX_PLAYER_NAME); //  playername
			SendClientMessage(playerid,COLOR_ORANGE, string);
			format(string,sizeof(string)," + '/cmcs %d' 명령어로 언제든지 차량소환이 가능합니다.",GetPlayerVehicleID(playerid));
		//	SendClientMessage(playerid,COLOR_RED," + 차량구매는 2009년 12월 25일 토요일 AM 12:00 에 마감 됩니다");
			SendClientMessage(playerid,COLOR_RED," + 차량 구매를 하셨으면 반드시 현재 서버 카페에 가셔서 차량구매 알림 게시판에 차샀다고 적어야 합니다 ");
            SendClientMessage(playerid,COLOR_RED," + 규칙을 따라 주지 않으시면 자신의 차량 데이터가 삭제 됩니다 차량구매 규칙 명령어 [/carhelp] ");
			SendClientMessage(playerid,COLOR_ORANGE, string);
...
// cmcs 명령어
	if (strcmp(stringslice(cmdtext,0), "/cmcs", true)==0)
	{
		new str;
		new Float:X,Float:Y,Float:Z;
...
SendClientMessage(playerid, COLOR_YELLOW, " + 감옥에서 차솬해서 머하게여???");
    return 1;
		...
		if(GetPlayerMoney(playerid)<CAR_SHOWS)
		{
			format(string,sizeof(string)," + $%d가 부족합니다.",CAR_CASHS-GetPlayerMoney(playerid));
			SendClientMessage(playerid,COLOR_ORANGERED,string);
			format(string,sizeof(string)," + 차량소환값은 $%d입니다.",CAR_SHOWS);
			SendClientMessage(playerid,COLOR_ORANGERED,string);
			return 1;
		}
		if(GetPlayerInterior(playerid) >= 1)
...
// carsells 명령어
	if (strcmp(stringslice(cmdtext,0), "/carsells", true)==0)
	{
		new str;
		if(!strlen(stringslice(cmdtext,1)))
		{
		...
		{
			GivePlayerMoney(playerid,CAR_CELLS);
		// GiveMoney(playerid,GetVehicleMoney(str)-120000);
	//		lock[str] = -1;
			carbuy_table[str] = "";
			new loadname[256];
			format(loadname,sizeof(loadname),"%d",str);
			dini_Unset("cardata2.cfg",loadname);
			format(string,sizeof(string)," + %d 차량을 차량을 팔았습니다.",str);
			SendClientMessage(playerid,COLOR_ORANGE, string);
		}
		else
		...
		for(new i=0; i<MAX_VEHICLES; i++)
		{
			...
			else if(strcmp(CAR_NAMES[playerid], carbuy_table[i], true) == 0)
			{
				if(GetVehicleType(i) == VT_CAR)
				{
					...
					if(carname > 211)
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 일반자동차 (파는 가격: $%d)",i,CAR_CELLS);
					}
					else
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 일반자동차 (%s) (파는 가격: $%d)",i,aVehicleNames[carname],CAR_CELLS);
					}
				}
				else if(GetVehicleType(i) == VT_HEAVY)
				{
					...
					if(carname > 211)
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 특수자동차 (파는 가격: $%d)               ",i,CAR_CELLS);
					}
					else
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 특수자동차 (%s) (파는 가격: $%d)",i,aVehicleNames[carname],CAR_CELLS);
					}
				}
				else if(GetVehicleType(i) == VT_MOTOR)
				{
					...
					if(carname > 211)
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 오토바이 (파는 가격: $%d)                 ",i,CAR_CELLS);
					}
					else
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 오토바이 (%s) (파는 가격: $%d)",i,aVehicleNames[carname],CAR_CELLS);
					}
				}
				else if(GetVehicleType(i) == VT_AIR)
				{
					...
					if(carname > 211)
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 비행기,헬기 (파는 가격: $%d)            ",i,CAR_CELLS);
					}
					else
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 비행기,헬기 (%s) (파는 가격: $%d)",i,aVehicleNames[carname],CAR_CELLS);
					}
				}
				else if(GetVehicleType(i) == VT_SEA)
				{
					...
					if(carname > 211)
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 보트 (파는 가격: $%d)                     ",i,CAR_CELLS);
					}
					else
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 보트 (%s) (파는 가격: $%d)",i,aVehicleNames[carname],CAR_CELLS);
					}
				}
				else if(GetVehicleType(i) == VT_BIKE)
				{
					...
					if(carname > 211)
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 자전거 (파는 가격: $%d)                   ",i,CAR_CELLS);
					}
					else
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 자전거 (%s) (파는 가격: $%d)",i,aVehicleNames[carname],CAR_CELLS);
					}
				}
				else if(GetVehicleType(i) == VT_TRAIN)
				{
					...
					if(carname > 211)
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 전차,기차 (파는 가격: $%d)                 ",i,CAR_CELLS);
					}
					else
					{
						format(tmpdata,sizeof(tmpdata)," + |%d| 전차,기차 (%s) (파는 가격: $%d)",i,aVehicleNames[carname],CAR_CELLS);
					}
				}
				else
				{
					format(tmpdata,sizeof(tmpdata)," + |%d| 알수없음 (파는 가격: $%d)                 ",i,CAR_CELLS);
				}
				SendClientMessage(playerid,COLOR_YELLOW,tmpdata);
				ab = 1;
			}
...
// JOB_CAR
 ...
 GetPlayerName(playerid, playername, sizeof(playername));
	...
	*/
	...
	SendClientMessage(playerid, COLOR_YELLOW, " 주식은 주식회사 당 50주 이하만 살 수 있습니다.");
	return 1;
	}
	...
	GivePlayerMoney(playerid, -jusicbuys*jusic7);
		...
		if(jusicbuytmp == 8)
	{
	if(jusicbuys + jusicbuy8[playerid] > 100) // 100으로 제한
	{
	SendClientMessage(playerid, COLOR_YELLOW, " 마스럴 주식은 주식회사 당 100주 까지만 살 수 있습니다.");
	return 1;
	}
